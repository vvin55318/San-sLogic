...
echo ' 
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form action="api.php?do=about_save_1" method="post" enctype="multipart/form-data">
                    <table class="table">
            ...
            <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                    <form action="api.php?do=about_save_2" method="post" enctype="multipart/form-data">
                      <table class="table">
                        <thead class=" text-san-blue">
                          <th width="10%">#</th>
                          <th width="20%">圖片</th>
  ...
  <script src="js/myjs/bg_about_ajax.js"></script>
