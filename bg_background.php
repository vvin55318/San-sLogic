...
<body>
  <div id="cover" style="display:none;position:absolute;width:100%;height:100%;background:#dddddd80;;z-index:9900" class="justify-content-center align-items-center">
...
<script>
  // 第一次進入，載入
  $.get("bg_home_ajax.php",function(re){
